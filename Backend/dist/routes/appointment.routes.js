...
//========================= PATIENTS ==================================
exports.AppointmentRoute.post('/:userId', isAuthenticated_1.isAuthenticated, (0, hasRole_1.hasRole)({
    roles: [""],
    allowSameUser: true,
...
exports.AppointmentRoute.get('/list/:id/:userId', isAuthenticated_1.isAuthenticated, (0, hasRole_1.hasRole)({
    roles: ["admin"],
    allowSameUser: true,
}), // Solamente el SU pueda acceder
(req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.AppointmentRoute.get('/patient/:id/:userId', isAuthenticated_1.isAuthenticated, (0, hasRole_1.hasRole)({
    roles: ["admin"],
    allowSameUser: true,
}), // Solamente el SU pueda acceder
(req, res) => __awaiter(void 0, void 0, void 0, function* () {
